...
class MarketSignal(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("probability_bullish >= 0 AND probability_bullish <= 100", name="ck_market_signals_bullish_range"),
        CheckConstraint("probability_bearish >= 0 AND probability_bearish <= 100", name="ck_market_signals_bearish_range"),
        CheckConstraint("signal_strength >= 0 AND signal_strength <= 100", name="ck_market_signals_strength_range"),
