...
class MarketSignal(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            ...
            name="ck_market_signals_source_confidence_range",
        ),
        CheckConstraint(
        ...
        CheckConstraint(
            ...
            name="ck_market_signals_signal_strength_range",
        ),
        CheckConstraint(
            "time_to_live_minutes > 0",
            name="ck_market_signals_ttl_positive",
        ),
        CheckConstraint(
            "sentiment_polarity IN ('positive', 'negative', 'neutral')",
            name="ck_market_signals_sentiment_polarity_values",
        ),
    )
